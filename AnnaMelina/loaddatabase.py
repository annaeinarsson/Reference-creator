import os
from referencecreator import db, bcrypt
from referencecreator.models import User, Project, Reference

try:
    os.remove('reference_creator/site.db')
...
default_user = User(username='Anna', email='anna@test.com', password=hashed_password)
db.session.add(default_user)

project = Project(title="Anna's test project", user=default_user, user_id=default_user.id)
